...
public class Graph implements IGraph {
    ...
    public String findShortestWay(String startPoint, String endPoint) {
        int startIndex = indexOf(startPoint);
        int endIndex = indexOf(endPoint);
        ...
        while (!queue.isEmpty()) {
            ...
            if (vertex != null) {
                ...
                vertex.setPrevVertex(prevVertex);

                if (vertex.getLabel().equals(endPoint)) {
                    return buildShortestWay(vertex);
                } else {
                    visitVertex(queue, vertex);
                }
            } else {
    ...
    private String buildShortestWay(Vertex lastVertex) {
        Stack<String> stack = new Stack<>();
        Vertex curVertex = lastVertex;

        while (curVertex != null) {
            stack.push(curVertex.getLabel());
            curVertex = curVertex.getPrevVertex();
        }

        StringBuilder sb = new StringBuilder("The shortest way is: Start -> ");
